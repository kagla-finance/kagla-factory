...
def remove_liquidity(
    ...
    KaglaMeta(_pool).remove_liquidity(_burn_amount, [_min_amounts[0], convert(0, uint256)])
    ...
    KaglaBase(BASE_POOL).remove_liquidity(meta_received[MAX_COIN], min_amounts_base)
